...
namespace Pc.Infraestrutura.Migrations
{
    ...
    [Migration("20260905190815_AddRagIndexDlq")]
    partial class AddRagIndexDlq
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pc.Dominio.Entities.Rag.DocumentoRag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Tipo", "EntidadeId")
                        .IsUnique()
                        .HasFilter("\"UsuarioId\" IS NULL");

                    b.ToTable("DocumentosRag", (string)null);
                });

            modelBuilder.Entity("Pc.Dominio.Entities.Rag.RagIndexDlq", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RagIndexDlq", (string)null);
                });
